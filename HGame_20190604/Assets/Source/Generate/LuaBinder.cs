...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		ShapeSpineEventWrap.Register(L);
		IsoSpriteControllerWrap.Register(L);
		PolyNavAgentWrap.Register(L);
		PolyNavAgentCallbackWrap.Register(L);
		PolyNav2DWrap.Register(L);
		SceneChangeRgnWrap.Register(L);
		ScrollViewEventTriggerWrap.Register(L);
		...
		L.EndModule();
		L.BeginModule("CinemachineVirtualCameraBase");
